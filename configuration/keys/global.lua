...
local globalKeys =
  ...
  awful.key({modkey, 'Control'}, 'q', _G.awesome.quit, {description = 'fast quit awesome', group = 'awesome'}),
  awful.key(
    {modkey},
    'Escape',
    function()
  ...
  awful.key(
    ...
    {description = 'search for program', group = 'awesome'}
  ),
  awful.key(
    {modkey},
    'l',
  ...
  awful.key(
    ...
    {description = 'powers down the system', group = 'hotkeys'}
  ),
  awful.key(
    {},
    'XF86PowerOff',
    ...
    {description = 'shuts down the system', group = 'hotkeys'}
  ),--]]
  ...
  awful.key(
    ...
    'c',
    function()
      awful.util.spawn(apps.default.text)
    end,
  ...
  awful.key(
    ...
    {description = 'take a screenshot of your active monitor after 10 seconds', group = 'screenshots'}
  ),
  awful.key(
    {},
    'Print',
